<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.0" xsi:schemaLocation="http://www.opengis.net/sld StyledLayerDescriptor.xsd">
  <!-- LAYER NAME level135_self_slipped -->
  <NamedLayer>
          ...
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>0.02709</ogc:Literal>
              </ogc:PropertyIsGreaterThan>
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>4.4421</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
        ...
        <Rule>
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>12.07079</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
        ...
        <Rule>
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>27.33142</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
        ...
        <Rule>
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>54.8043</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
        ...
        <Rule>
          <ogc:Filter>
            <ogc:And>
              ...
              <ogc:PropertyIsLessThanOrEqualTo>
                <ogc:PropertyName>qryPottFabDen.SS</ogc:PropertyName>
                <ogc:Literal>114.59809</ogc:Literal>
              </ogc:PropertyIsLessThanOrEqualTo>
            </ogc:And>
          </ogc:Filter>
          <PolygonSymbolizer>
